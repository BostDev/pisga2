...
class _MySidebarState extends State<MySidebar> {
  ...
  // void _getWeatherUpdate(String city) {

  // OpenWeatherMapAPI api = OpenWeatherMapAPI(0af91b7826854c791de8fa120991d2e3);
  //Uri weatherUri = api.weather(city);
